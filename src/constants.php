...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "18.2.1");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "wfg_appraisal"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{253C54E3-FFFF-4F64-9A03-15AE59013125}"); // Project ID
