...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'q7ae76D19rZEydEJ', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/wfg_appraisal.css", // Project stylesheet file name
    ...
    "USER_TABLE_NAME" => "main_users",
    "LOGIN_USERNAME_FIELD_NAME" => "emailaddress",
    "LOGIN_PASSWORD_FIELD_NAME" => "emppassword",
    "USER_ID_FIELD_NAME" => "id",
    "PARENT_USER_ID_FIELD_NAME" => "",
    "USER_LEVEL_FIELD_NAME" => "emprole",
    "USER_PROFILE_FIELD_NAME" => "",
    "REGISTER_ACTIVATE_FIELD_NAME" => "tourflag",
    "USER_EMAIL_FIELD_NAME" => "emailaddress",
    ...
    // User table filters
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "`main_users`",
    "USER_NAME_FILTER" => "(`emailaddress` = '%u')",
    "USER_ID_FILTER" => "(`id` = %u)",
    "USER_EMAIL_FILTER" => "(`emailaddress` = '%e')",
