...
// Page object
$MainPaAppraisalhistoryAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { main_pa_appraisalhistory: currentTable } });
var currentForm, currentPageID;
var fmain_pa_appraisalhistoryadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmain_pa_appraisalhistoryadd = new ew.Form("fmain_pa_appraisalhistoryadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fmain_pa_appraisalhistoryadd;

    // Add fields
    var fields = currentTable.fields;
    fmain_pa_appraisalhistoryadd.addFields([
    ...
    // Form_CustomValidate
    fmain_pa_appraisalhistoryadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmain_pa_appraisalhistoryadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fmain_pa_appraisalhistoryadd.lists.employee_id = <?= $Page->employee_id->toClientList($Page) ?>;
    fmain_pa_appraisalhistoryadd.lists.pa_initialization_id = <?= $Page->pa_initialization_id->toClientList($Page) ?>;
    fmain_pa_appraisalhistoryadd.lists.createdby = <?= $Page->createdby->toClientList($Page) ?>;
    fmain_pa_appraisalhistoryadd.lists.modifiedby = <?= $Page->modifiedby->toClientList($Page) ?>;
    loadjs.done("fmain_pa_appraisalhistoryadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fmain_pa_appraisalhistoryadd" id="fmain_pa_appraisalhistoryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_main_pa_appraisalhistory_employee_id">
    <select
        ...
        data-select2-id="fmain_pa_appraisalhistoryadd_x_employee_id"
...
<script>
loadjs.ready("fmain_pa_appraisalhistoryadd", function() {
    var options = { name: "x_employee_id", selectId: "fmain_pa_appraisalhistoryadd_x_employee_id" };
    if (fmain_pa_appraisalhistoryadd.lists.employee_id.lookupOptions.length) {
        options.data = { id: "x_employee_id", form: "fmain_pa_appraisalhistoryadd" };
    } else {
        options.ajax = { id: "x_employee_id", form: "fmain_pa_appraisalhistoryadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_appraisalhistory_pa_initialization_id">
    <select
        ...
        data-select2-id="fmain_pa_appraisalhistoryadd_x_pa_initialization_id"
        data-table="main_pa_appraisalhistory"
...
<script>
loadjs.ready("fmain_pa_appraisalhistoryadd", function() {
    var options = { name: "x_pa_initialization_id", selectId: "fmain_pa_appraisalhistoryadd_x_pa_initialization_id" };
    if (fmain_pa_appraisalhistoryadd.lists.pa_initialization_id.lookupOptions.length) {
        options.data = { id: "x_pa_initialization_id", form: "fmain_pa_appraisalhistoryadd" };
    } else {
        options.ajax = { id: "x_pa_initialization_id", form: "fmain_pa_appraisalhistoryadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
