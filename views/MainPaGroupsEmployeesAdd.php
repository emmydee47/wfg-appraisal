...
// Page object
$MainPaGroupsEmployeesAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { main_pa_groups_employees: currentTable } });
var currentForm, currentPageID;
var fmain_pa_groups_employeesadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmain_pa_groups_employeesadd = new ew.Form("fmain_pa_groups_employeesadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fmain_pa_groups_employeesadd;

    // Add fields
    var fields = currentTable.fields;
    fmain_pa_groups_employeesadd.addFields([
    ...
    // Form_CustomValidate
    fmain_pa_groups_employeesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmain_pa_groups_employeesadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fmain_pa_groups_employeesadd.lists.group_id = <?= $Page->group_id->toClientList($Page) ?>;
    fmain_pa_groups_employeesadd.lists.employee_id = <?= $Page->employee_id->toClientList($Page) ?>;
    loadjs.done("fmain_pa_groups_employeesadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fmain_pa_groups_employeesadd" id="fmain_pa_groups_employeesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_main_pa_groups_employees_group_id">
    <select
        ...
        data-select2-id="fmain_pa_groups_employeesadd_x_group_id"
...
<script>
loadjs.ready("fmain_pa_groups_employeesadd", function() {
    var options = { name: "x_group_id", selectId: "fmain_pa_groups_employeesadd_x_group_id" };
    if (fmain_pa_groups_employeesadd.lists.group_id.lookupOptions.length) {
        options.data = { id: "x_group_id", form: "fmain_pa_groups_employeesadd" };
    } else {
        options.ajax = { id: "x_group_id", form: "fmain_pa_groups_employeesadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_groups_employees_employee_id">
    <select
        ...
        data-select2-id="fmain_pa_groups_employeesadd_x_employee_id"
        data-table="main_pa_groups_employees"
...
<script>
loadjs.ready("fmain_pa_groups_employeesadd", function() {
    var options = { name: "x_employee_id", selectId: "fmain_pa_groups_employeesadd_x_employee_id" };
    if (fmain_pa_groups_employeesadd.lists.employee_id.lookupOptions.length) {
        options.data = { id: "x_employee_id", form: "fmain_pa_groups_employeesadd" };
    } else {
        options.ajax = { id: "x_employee_id", form: "fmain_pa_groups_employeesadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
