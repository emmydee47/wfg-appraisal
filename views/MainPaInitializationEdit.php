...
// Page object
$MainPaInitializationEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { main_pa_initialization: currentTable } });
var currentForm, currentPageID;
var fmain_pa_initializationedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmain_pa_initializationedit = new ew.Form("fmain_pa_initializationedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fmain_pa_initializationedit;

    // Add fields
    var fields = currentTable.fields;
    fmain_pa_initializationedit.addFields([
    ...
    // Form_CustomValidate
    fmain_pa_initializationedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmain_pa_initializationedit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fmain_pa_initializationedit.lists.business_unit = <?= $Page->business_unit->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.group_id = <?= $Page->group_id->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.appraisal_mode = <?= $Page->appraisal_mode->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.appraisal_period = <?= $Page->appraisal_period->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.from_year = <?= $Page->from_year->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.to_year = <?= $Page->to_year->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.initialize_status = <?= $Page->initialize_status->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.appraisal_ratings = <?= $Page->appraisal_ratings->toClientList($Page) ?>;
    fmain_pa_initializationedit.lists.isactive = <?= $Page->isactive->toClientList($Page) ?>;
    loadjs.done("fmain_pa_initializationedit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fmain_pa_initializationedit" id="fmain_pa_initializationedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_main_pa_initialization_id" for="x_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_main_pa_initialization_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="main_pa_initialization" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<?php $Page->business_unit->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="fmain_pa_initializationedit_x_business_unit"
...
<script>
loadjs.ready("fmain_pa_initializationedit", function() {
    var options = { name: "x_business_unit", selectId: "fmain_pa_initializationedit_x_business_unit" };
    if (fmain_pa_initializationedit.lists.business_unit.lookupOptions.length) {
        options.data = { id: "x_business_unit", form: "fmain_pa_initializationedit" };
    } else {
        options.ajax = { id: "x_business_unit", form: "fmain_pa_initializationedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_initialization_group_id">
    <select
        ...
        data-select2-id="fmain_pa_initializationedit_x_group_id"
        data-table="main_pa_initialization"
...
<script>
loadjs.ready("fmain_pa_initializationedit", function() {
    var options = { name: "x_group_id", selectId: "fmain_pa_initializationedit_x_group_id" };
    if (fmain_pa_initializationedit.lists.group_id.lookupOptions.length) {
        options.data = { id: "x_group_id", form: "fmain_pa_initializationedit" };
    } else {
        options.ajax = { id: "x_group_id", form: "fmain_pa_initializationedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_initialization_appraisal_period">
    <select
        ...
        data-select2-id="fmain_pa_initializationedit_x_appraisal_period"
        data-table="main_pa_initialization"
...
<script>
loadjs.ready("fmain_pa_initializationedit", function() {
    var options = { name: "x_appraisal_period", selectId: "fmain_pa_initializationedit_x_appraisal_period" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmain_pa_initializationedit.lists.appraisal_period.lookupOptions.length) {
        options.data = { id: "x_appraisal_period", form: "fmain_pa_initializationedit" };
    } else {
        options.ajax = { id: "x_appraisal_period", form: "fmain_pa_initializationedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_initialization_from_year">
    <select
        ...
        data-select2-id="fmain_pa_initializationedit_x_from_year"
        data-table="main_pa_initialization"
...
<script>
loadjs.ready("fmain_pa_initializationedit", function() {
    var options = { name: "x_from_year", selectId: "fmain_pa_initializationedit_x_from_year" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmain_pa_initializationedit.lists.from_year.lookupOptions.length) {
        options.data = { id: "x_from_year", form: "fmain_pa_initializationedit" };
    } else {
        options.ajax = { id: "x_from_year", form: "fmain_pa_initializationedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_main_pa_initialization_to_year">
    <select
        ...
        data-select2-id="fmain_pa_initializationedit_x_to_year"
        data-table="main_pa_initialization"
...
<script>
loadjs.ready("fmain_pa_initializationedit", function() {
    var options = { name: "x_to_year", selectId: "fmain_pa_initializationedit_x_to_year" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmain_pa_initializationedit.lists.to_year.lookupOptions.length) {
        options.data = { id: "x_to_year", form: "fmain_pa_initializationedit" };
    } else {
        options.ajax = { id: "x_to_year", form: "fmain_pa_initializationedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<script>
loadjs.ready(["fmain_pa_initializationedit", "datetimepicker"], function () {
    let options = {
        localization: {
    ...
    ew.createDateTimePicker("fmain_pa_initializationedit", "x_employees_due_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmain_pa_initializationedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmain_pa_initializationedit", "x_managers_due_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready("fmain_pa_initializationedit", function() {
    fmain_pa_initializationedit.createAutoSuggest(Object.assign({"id":"x_appraisal_ratings","forceSelect":false}, ew.vars.tables.main_pa_initialization.fields.appraisal_ratings.autoSuggestOptions));
});
</script>
