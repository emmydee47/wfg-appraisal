...
// Page object
$MainPaGroupManagerAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { main_pa_group_manager: currentTable } });
var currentForm, currentPageID;
var fmain_pa_group_manageradd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmain_pa_group_manageradd = new ew.Form("fmain_pa_group_manageradd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fmain_pa_group_manageradd;

    // Add fields
    var fields = currentTable.fields;
    fmain_pa_group_manageradd.addFields([
    ...
    // Form_CustomValidate
    fmain_pa_group_manageradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmain_pa_group_manageradd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fmain_pa_group_manageradd.lists.business_unit = <?= $Page->business_unit->toClientList($Page) ?>;
    fmain_pa_group_manageradd.lists.group_id = <?= $Page->group_id->toClientList($Page) ?>;
    fmain_pa_group_manageradd.lists.line_manager = <?= $Page->line_manager->toClientList($Page) ?>;
    fmain_pa_group_manageradd.lists.level = <?= $Page->level->toClientList($Page) ?>;
    loadjs.done("fmain_pa_group_manageradd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fmain_pa_group_manageradd" id="fmain_pa_group_manageradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_main_pa_group_manager_business_unit">
    <select
        ...
        data-select2-id="fmain_pa_group_manageradd_x_business_unit"
...
<script>
loadjs.ready("fmain_pa_group_manageradd", function() {
    var options = { name: "x_business_unit", selectId: "fmain_pa_group_manageradd_x_business_unit" };
    if (fmain_pa_group_manageradd.lists.business_unit.lookupOptions.length) {
        options.data = { id: "x_business_unit", form: "fmain_pa_group_manageradd" };
    } else {
        options.ajax = { id: "x_business_unit", form: "fmain_pa_group_manageradd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_group_manager_group_id">
    <select
        ...
        data-select2-id="fmain_pa_group_manageradd_x_group_id"
        data-table="main_pa_group_manager"
...
<script>
loadjs.ready("fmain_pa_group_manageradd", function() {
    var options = { name: "x_group_id", selectId: "fmain_pa_group_manageradd_x_group_id" };
    if (fmain_pa_group_manageradd.lists.group_id.lookupOptions.length) {
        options.data = { id: "x_group_id", form: "fmain_pa_group_manageradd" };
    } else {
        options.ajax = { id: "x_group_id", form: "fmain_pa_group_manageradd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_group_manager_line_manager">
    <select
        ...
        data-select2-id="fmain_pa_group_manageradd_x_line_manager"
        data-table="main_pa_group_manager"
...
<script>
loadjs.ready("fmain_pa_group_manageradd", function() {
    var options = { name: "x_line_manager", selectId: "fmain_pa_group_manageradd_x_line_manager" };
    if (fmain_pa_group_manageradd.lists.line_manager.lookupOptions.length) {
        options.data = { id: "x_line_manager", form: "fmain_pa_group_manageradd" };
    } else {
        options.ajax = { id: "x_line_manager", form: "fmain_pa_group_manageradd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_main_pa_group_manager_level">
    <select
        ...
        data-select2-id="fmain_pa_group_manageradd_x_level"
        data-table="main_pa_group_manager"
        data-field="x_level"
...
<script>
loadjs.ready("fmain_pa_group_manageradd", function() {
    var options = { name: "x_level", selectId: "fmain_pa_group_manageradd_x_level" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmain_pa_group_manageradd.lists.level.lookupOptions.length) {
        options.data = { id: "x_level", form: "fmain_pa_group_manageradd" };
    } else {
        options.ajax = { id: "x_level", form: "fmain_pa_group_manageradd", limit: ew.LOOKUP_PAGE_SIZE };
    }
