...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->isactive->isInvalidClass() ?>" data-table="main_pa_employee_ratings" data-field="x_isactive" name="x_isactive[]" id="x_isactive_666782" value="1"<?= ConvertToBool($Page->isactive->AdvancedSearch->SearchValue) ? " checked" : "" ?><?= $Page->isactive->editAttributes() ?>>
