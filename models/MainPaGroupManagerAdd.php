 ...
 * Page class
 */
class MainPaGroupManagerAdd extends MainPaGroupManager
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupManagerAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "mainpagroupmanagerview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->business_unit->CurrentValue = 0;
        $this->group_id->CurrentValue = null;
        $this->group_id->OldValue = $this->group_id->CurrentValue;
        $this->line_manager->CurrentValue = null;
        $this->line_manager->OldValue = $this->line_manager->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['line_manager'] = $this->line_manager->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // business_unit
        $this->business_unit->setDbValueDef($rsnew, $this->business_unit->CurrentValue, 0, strval($this->business_unit->CurrentValue) == "");

        // group_id
        $this->group_id->setDbValueDef($rsnew, $this->group_id->CurrentValue, null, false);

        // line_manager
        $this->line_manager->setDbValueDef($rsnew, $this->line_manager->CurrentValue, null, false);
