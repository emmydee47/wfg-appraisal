 ...
 * Page class
 */
class MainPaQuestionsDelete extends MainPaQuestions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaQuestionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mainpaquestionslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mainpaquestionslist"); // Return to list
                return;
            }
        }
