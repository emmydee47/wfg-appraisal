...
/**
 * Table class for pending_appraisal_ratings
 */
class PendingAppraisalRatings extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pending_appraisal_ratings';
        $this->TableName = 'pending_appraisal_ratings';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`pending_appraisal_ratings`";
        $this->Dbid = 'DB';
        ...
        $this->appraisal_status->Lookup = new Lookup('appraisal_status', 'pending_appraisal_ratings', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pending_appraisal_ratings`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("pendingappraisalratingslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "pendingappraisalratingsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "pendingappraisalratingsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "pendingappraisalratingsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PendingAppraisalRatingsView";
            case Config("API_ADD_ACTION"):
                return "PendingAppraisalRatingsAdd";
            case Config("API_EDIT_ACTION"):
                return "PendingAppraisalRatingsEdit";
            case Config("API_DELETE_ACTION"):
                return "PendingAppraisalRatingsDelete";
            case Config("API_LIST_ACTION"):
                return "PendingAppraisalRatingsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("pendingappraisalratingsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("pendingappraisalratingsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "pendingappraisalratingsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "pendingappraisalratingsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pendingappraisalratingsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pendingappraisalratingsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("pendingappraisalratingsdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->line_manager->EditValue = $this->line_manager->CurrentValue;
        $this->line_manager->PlaceHolder = RemoveHtml($this->line_manager->caption());
        if (strval($this->line_manager->EditValue) != "" && is_numeric($this->line_manager->EditValue)) {
            $this->line_manager->EditValue = FormatNumber($this->line_manager->EditValue, null);
        }
        ...
        if (strval($this->level->EditValue) != "" && is_numeric($this->level->EditValue)) {
            $this->level->EditValue = FormatNumber($this->level->EditValue, null);
        }
