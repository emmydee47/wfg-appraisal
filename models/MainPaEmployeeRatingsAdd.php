 ...
 * Page class
 */
class MainPaEmployeeRatingsAdd extends MainPaEmployeeRatings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaEmployeeRatingsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "mainpaemployeeratingsview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->appraisal_id->CurrentValue = null;
        ...
        $this->consolidated_rating->CurrentValue = null;
        $this->consolidated_rating->OldValue = $this->consolidated_rating->CurrentValue;
        $this->appraisal_status->CurrentValue = "Pending employee ratings";
    ...
    protected function newRow()
    {
        ...
        $row['consolidated_rating'] = $this->consolidated_rating->CurrentValue;
        $row['appraisal_status'] = $this->appraisal_status->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // appraisal_id
        $this->appraisal_id->setDbValueDef($rsnew, $this->appraisal_id->CurrentValue, null, false);

        // employee_id
        $this->employee_id->setDbValueDef($rsnew, $this->employee_id->CurrentValue, null, false);

        // consolidated_rating
        $this->consolidated_rating->setDbValueDef($rsnew, $this->consolidated_rating->CurrentValue, null, false);

        // appraisal_status
        $this->appraisal_status->setDbValueDef($rsnew, $this->appraisal_status->CurrentValue, null, strval($this->appraisal_status->CurrentValue) == "");
