 ...
 * Page class
 */
class MainPaGroupsDelete extends MainPaGroups
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mainpagroupslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mainpagroupslist"); // Return to list
                return;
            }
        }
