 ...
 * Page class
 */
class MessageTemplatesView extends MessageTemplates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MessageTemplatesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "messagetemplateslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "messagetemplateslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "messagetemplateslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
