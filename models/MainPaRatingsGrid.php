 ...
 * Page class
 */
class MainPaRatingsGrid extends MainPaRatings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaRatingsGrid";
    ...
    public $FormName = "fmain_pa_ratingsgrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "appraisal_ratings") {
            $this->rating_type->CurrentValue = $this->rating_type->getSessionValue();
        }
        $conn = $this->getConnection();
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "appraisal_ratings") {
            $masterTbl = Container("appraisal_ratings");
            $this->rating_type->Visible = false;
