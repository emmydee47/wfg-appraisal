 ...
 * Page class
 */
class MainPaGroupsEmployeesGrid extends MainPaGroupsEmployees
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupsEmployeesGrid";
    ...
    public $FormName = "fmain_pa_groups_employeesgrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "main_pa_groups") {
            $this->group_id->CurrentValue = $this->group_id->getSessionValue();
        }
