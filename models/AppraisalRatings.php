...
/**
 * Table class for appraisal_ratings
 */
class AppraisalRatings extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'appraisal_ratings';
        $this->TableName = 'appraisal_ratings';
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "main_pa_ratings") {
            $detailUrl = Container("main_pa_ratings")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "appraisalratingslist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`appraisal_ratings`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("appraisalratingslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "appraisalratingsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "appraisalratingsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "appraisalratingsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AppraisalRatingsView";
            case Config("API_ADD_ACTION"):
                return "AppraisalRatingsAdd";
            case Config("API_EDIT_ACTION"):
                return "AppraisalRatingsEdit";
            case Config("API_DELETE_ACTION"):
                return "AppraisalRatingsDelete";
            case Config("API_LIST_ACTION"):
                return "AppraisalRatingsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("appraisalratingsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("appraisalratingsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "appraisalratingsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "appraisalratingsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appraisalratingsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appraisalratingsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("appraisalratingsdelete", $this->getUrlParm());
    }
