 ...
 * Page class
 */
class MainPaRatingsView extends MainPaRatings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaRatingsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "mainparatingslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "mainparatingslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "mainparatingslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
