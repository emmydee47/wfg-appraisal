...
/**
 * Table class for main_pa_groups_employees
 */
class MainPaGroupsEmployees extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'main_pa_groups_employees';
        $this->TableName = 'main_pa_groups_employees';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`main_pa_groups_employees`";
        $this->Dbid = 'DB';
        ...
        $this->group_id->IsForeignKey = true; // Foreign key field
    ...
    public function getMasterFilterFromSession()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "main_pa_groups") {
            if ($this->group_id->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->group_id->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "main_pa_groups") {
            if ($this->group_id->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`group_id`", $this->group_id->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "main_pa_groups":
                ...
                if ($validKeys) {
                    return "`id`=" . QuotedValue($keys["group_id"], $masterTable->id->DataType, $masterTable->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "main_pa_groups":
                return "`group_id`=" . QuotedValue($masterTable->id->DbValue, $this->group_id->DataType, $this->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`main_pa_groups_employees`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("mainpagroupsemployeeslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "mainpagroupsemployeesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "mainpagroupsemployeesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "mainpagroupsemployeesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MainPaGroupsEmployeesView";
            case Config("API_ADD_ACTION"):
                return "MainPaGroupsEmployeesAdd";
            case Config("API_EDIT_ACTION"):
                return "MainPaGroupsEmployeesEdit";
            case Config("API_DELETE_ACTION"):
                return "MainPaGroupsEmployeesDelete";
            case Config("API_LIST_ACTION"):
                return "MainPaGroupsEmployeesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mainpagroupsemployeesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mainpagroupsemployeesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "mainpagroupsemployeesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "mainpagroupsemployeesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpagroupsemployeesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpagroupsemployeesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("mainpagroupsemployeesdelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "main_pa_groups" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->group_id->CurrentValue);
        }
        return $url;
    }
    ...
    {
        $table = 'main_pa_groups_employees';
        $usr = CurrentUserID();
