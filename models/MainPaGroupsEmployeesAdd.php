 ...
 * Page class
 */
class MainPaGroupsEmployeesAdd extends MainPaGroupsEmployees
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupsEmployeesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("mainpagroupsemployeeslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "mainpagroupsemployeeslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "mainpagroupsemployeesview") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("mainpagroupsemployeeslist"), "", $this->TableVar, true);
