 ...
 * Page class
 */
class MainGroupPaQuestionsGrid extends MainGroupPaQuestions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainGroupPaQuestionsGrid";
    ...
    public $FormName = "fmain_group_pa_questionsgrid";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // appraisal_id
            if ($this->appraisal_id->getSessionValue() != "") {
                $this->appraisal_id->ReadOnly = true;
            }
            $this->appraisal_id->setDbValueDef($rsnew, $this->appraisal_id->CurrentValue, 0, $this->appraisal_id->ReadOnly);
            ...
            $this->question->setDbValueDef($rsnew, $this->question->CurrentValue, 0, $this->question->ReadOnly);

            // Check referential integrity for master table 'main_pa_initialization'
            $detailKeys = [];
            $keyValue = $rsnew['appraisal_id'] ?? $rsold['appraisal_id'];
            $detailKeys['appraisal_id'] = $keyValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "main_pa_initialization") {
            $this->appraisal_id->CurrentValue = $this->appraisal_id->getSessionValue();
        }
        if ($this->getCurrentMasterTable() == "main_pa_questions") {
            $this->question->CurrentValue = $this->question->getSessionValue();
        }
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "main_pa_initialization") {
            $masterTbl = Container("main_pa_initialization");
            $this->appraisal_id->Visible = false;
