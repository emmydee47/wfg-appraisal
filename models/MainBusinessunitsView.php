 ...
 * Page class
 */
class MainBusinessunitsView extends MainBusinessunits
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainBusinessunitsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "mainbusinessunitslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "mainbusinessunitslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "mainbusinessunitslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
