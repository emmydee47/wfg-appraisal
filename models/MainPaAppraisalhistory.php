...
/**
 * Table class for main_pa_appraisalhistory
 */
class MainPaAppraisalhistory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'main_pa_appraisalhistory';
        $this->TableName = 'main_pa_appraisalhistory';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`main_pa_appraisalhistory`";
        $this->Dbid = 'DB';
        ...
        $this->pa_initialization_id->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->pa_initialization_id->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->pa_initialization_id->Lookup = new Lookup('pa_initialization_id', 'main_pa_initialization', false, 'id', ["group_id","appraisal_period","from_year","to_year"], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`group_id`, ''),'" . ValueSeparator(1, $this->pa_initialization_id) . "',COALESCE(`appraisal_period`,''),'" . ValueSeparator(2, $this->pa_initialization_id) . "',COALESCE(`from_year`,''),'" . ValueSeparator(3, $this->pa_initialization_id) . "',COALESCE(`to_year`,''))");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`main_pa_appraisalhistory`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("mainpaappraisalhistorylist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "mainpaappraisalhistoryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "mainpaappraisalhistoryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MainPaAppraisalhistoryView";
            case Config("API_ADD_ACTION"):
                return "MainPaAppraisalhistoryAdd";
            case Config("API_EDIT_ACTION"):
                return "MainPaAppraisalhistoryEdit";
            case Config("API_DELETE_ACTION"):
                return "MainPaAppraisalhistoryDelete";
            case Config("API_LIST_ACTION"):
                return "MainPaAppraisalhistoryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mainpaappraisalhistoryview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mainpaappraisalhistoryview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "mainpaappraisalhistoryadd?" . $this->getUrlParm($parm);
        } else {
            $url = "mainpaappraisalhistoryadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpaappraisalhistoryedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpaappraisalhistoryadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("mainpaappraisalhistorydelete", $this->getUrlParm());
    }
    ...
    {
        $table = 'main_pa_appraisalhistory';
        $usr = CurrentUserID();
