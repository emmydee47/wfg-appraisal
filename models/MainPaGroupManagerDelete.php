 ...
 * Page class
 */
class MainPaGroupManagerDelete extends MainPaGroupManager
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupManagerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mainpagroupmanagerlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mainpagroupmanagerlist"); // Return to list
                return;
            }
        }
