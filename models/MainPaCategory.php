...
/**
 * Table class for main_pa_category
 */
class MainPaCategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'main_pa_category';
        $this->TableName = 'main_pa_category';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`main_pa_category`";
        $this->Dbid = 'DB';
        ...
        $this->isactive->Lookup = new Lookup('isactive', 'main_pa_category', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->isused->InputTextType = "text";
        $this->isused->DataType = DATATYPE_BOOLEAN;
        $this->isused->Lookup = new Lookup('isused', 'main_pa_category', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        $this->isused->OptionCount = 2;
        $this->isused->DefaultErrorMessage = $Language->phrase("IncorrectField");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`main_pa_category`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("mainpacategorylist");
    }
    ...
    {
        global $Language;
        if ($pageName == "mainpacategoryview") {
            return $Language->phrase("View");
        } elseif ($pageName == "mainpacategoryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "mainpacategoryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MainPaCategoryView";
            case Config("API_ADD_ACTION"):
                return "MainPaCategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "MainPaCategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "MainPaCategoryDelete";
            case Config("API_LIST_ACTION"):
                return "MainPaCategoryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mainpacategoryview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mainpacategoryview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "mainpacategoryadd?" . $this->getUrlParm($parm);
        } else {
            $url = "mainpacategoryadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpacategoryedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpacategoryadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("mainpacategorydelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        // isused
        if (ConvertToBool($this->isused->CurrentValue)) {
            $this->isused->ViewValue = $this->isused->tagCaption(1) != "" ? $this->isused->tagCaption(1) : "Yes";
        } else {
            $this->isused->ViewValue = $this->isused->tagCaption(2) != "" ? $this->isused->tagCaption(2) : "No";
        }
    ...
    public function renderEditRow()
    {
        ...
        $this->isused->EditValue = $this->isused->options(false);
