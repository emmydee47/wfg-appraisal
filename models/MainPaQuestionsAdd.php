 ...
 * Page class
 */
class MainPaQuestionsAdd extends MainPaQuestions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaQuestionsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "mainpaquestionsview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("MainGroupPaQuestionsGrid");
            if (in_array("main_group_pa_questions", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->question->setSessionValue($this->id->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->question->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
