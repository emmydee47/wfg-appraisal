 ...
 * Page class
 */
class MainPaGroupsEmployeesDelete extends MainPaGroupsEmployees
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupsEmployeesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mainpagroupsemployeeslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mainpagroupsemployeeslist"); // Return to list
                return;
            }
        }
