...
/**
 * Table class for main_pa_questions
 */
class MainPaQuestions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'main_pa_questions';
        $this->TableName = 'main_pa_questions';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`main_pa_questions`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->group->Lookup = new Lookup('group', 'main_pa_groups', false, 'id', ["business_unit","group_name","",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`business_unit`, ''),'" . ValueSeparator(1, $this->group) . "',COALESCE(`group_name`,''))");
        ...
        $this->modified_by->InputTextType = "text";
        $this->modified_by->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        ...
        $this->created_date = new DbField(
            ...
            'created_date',
            '`created_date`',
            CastDateFieldForLike("`created_date`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        // modified_date
        $this->modified_date = new DbField(
            'main_pa_questions',
            'main_pa_questions',
            'x_modified_date',
            'modified_date',
            '`modified_date`',
            CastDateFieldForLike("`modified_date`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        $this->modified_date->InputTextType = "text";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`main_pa_questions`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("mainpaquestionslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "mainpaquestionsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "mainpaquestionsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MainPaQuestionsView";
            case Config("API_ADD_ACTION"):
                return "MainPaQuestionsAdd";
            case Config("API_EDIT_ACTION"):
                return "MainPaQuestionsEdit";
            case Config("API_DELETE_ACTION"):
                return "MainPaQuestionsDelete";
            case Config("API_LIST_ACTION"):
                return "MainPaQuestionsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mainpaquestionsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mainpaquestionsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "mainpaquestionsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "mainpaquestionsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mainpaquestionsedit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mainpaquestionsedit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mainpaquestionsadd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mainpaquestionsadd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("mainpaquestionsdelete", $this->getUrlParm());
    }
