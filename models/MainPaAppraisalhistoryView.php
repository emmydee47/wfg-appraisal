 ...
 * Page class
 */
class MainPaAppraisalhistoryView extends MainPaAppraisalhistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaAppraisalhistoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "mainpaappraisalhistorylist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "mainpaappraisalhistorylist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "mainpaappraisalhistorylist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
