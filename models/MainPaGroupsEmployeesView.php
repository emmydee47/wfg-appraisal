 ...
 * Page class
 */
class MainPaGroupsEmployeesView extends MainPaGroupsEmployees
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupsEmployeesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "mainpagroupsemployeeslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "mainpagroupsemployeeslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "mainpagroupsemployeeslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
