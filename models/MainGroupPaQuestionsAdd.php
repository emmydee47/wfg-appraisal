 ...
 * Page class
 */
class MainGroupPaQuestionsAdd extends MainGroupPaQuestions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainGroupPaQuestionsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("maingrouppaquestionslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "maingrouppaquestionslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "maingrouppaquestionsview") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("maingrouppaquestionslist"), "", $this->TableVar, true);
