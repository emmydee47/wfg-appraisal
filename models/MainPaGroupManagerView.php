 ...
 * Page class
 */
class MainPaGroupManagerView extends MainPaGroupManager
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaGroupManagerView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "mainpagroupmanagerlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "mainpagroupmanagerlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "mainpagroupmanagerlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
