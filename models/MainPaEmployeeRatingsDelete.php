 ...
 * Page class
 */
class MainPaEmployeeRatingsDelete extends MainPaEmployeeRatings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaEmployeeRatingsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mainpaemployeeratingslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mainpaemployeeratingslist"); // Return to list
                return;
            }
        }
