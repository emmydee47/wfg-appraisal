 ...
 * Page class
 */
class MainPaRatingsDelete extends MainPaRatings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaRatingsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mainparatingslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mainparatingslist"); // Return to list
                return;
            }
        }
