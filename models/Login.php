...
class Login extends MainUsers
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("main_users", "main_users", "username", "username", "username", "", 202, 255, -1, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-form-control");
        $this->Password = new DbField("main_users", "main_users", "password", "password", "password", "", 202, 255, -1, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-form-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("main_users", "main_users", "type", "logintype", "logintype", "", 202, 255, -1, false, "", false, false, false);
