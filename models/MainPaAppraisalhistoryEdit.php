 ...
 * Page class
 */
class MainPaAppraisalhistoryEdit extends MainPaAppraisalhistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaAppraisalhistoryEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // pa_initialization_id
            $this->pa_initialization_id->setDbValueDef($rsnew, $this->pa_initialization_id->CurrentValue, null, $this->pa_initialization_id->ReadOnly);
