...
class MainPaGroupsList extends MainPaGroups
{
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->group_name, $default, false); // group_name
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->group_name->AdvancedSearch->save(); // group_name
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->group_name->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->group_name->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->group_name->AdvancedSearch->load();
    ...
    protected function loadSearchValues()
    {
        ...
        // group_name
        if ($this->group_name->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->group_name->AdvancedSearch->SearchValue != "" || $this->group_name->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->group_name->EditCustomAttributes = "";
            if (!$this->group_name->Raw) {
                $this->group_name->AdvancedSearch->SearchValue = HtmlDecode($this->group_name->AdvancedSearch->SearchValue);
            }
            $this->group_name->EditValue = HtmlEncode($this->group_name->AdvancedSearch->SearchValue);
            $this->group_name->PlaceHolder = RemoveHtml($this->group_name->caption());
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fmain_pa_groupslist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
