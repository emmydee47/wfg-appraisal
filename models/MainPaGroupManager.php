...
/**
 * Table class for main_pa_group_manager
 */
class MainPaGroupManager extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'main_pa_group_manager';
        $this->TableName = 'main_pa_group_manager';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`main_pa_group_manager`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->level->Lookup = new Lookup('level', 'main_pa_group_manager', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`main_pa_group_manager`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("mainpagroupmanagerlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "mainpagroupmanageredit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "mainpagroupmanageradd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MainPaGroupManagerView";
            case Config("API_ADD_ACTION"):
                return "MainPaGroupManagerAdd";
            case Config("API_EDIT_ACTION"):
                return "MainPaGroupManagerEdit";
            case Config("API_DELETE_ACTION"):
                return "MainPaGroupManagerDelete";
            case Config("API_LIST_ACTION"):
                return "MainPaGroupManagerList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mainpagroupmanagerview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("mainpagroupmanagerview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "mainpagroupmanageradd?" . $this->getUrlParm($parm);
        } else {
            $url = "mainpagroupmanageradd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpagroupmanageredit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mainpagroupmanageradd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("mainpagroupmanagerdelete", $this->getUrlParm());
    }
