 ...
 * Page class
 */
class MessageTemplatesEdit extends MessageTemplates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MessageTemplatesEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // recepient_group
            $this->recepient_group->setDbValueDef($rsnew, $this->recepient_group->CurrentValue, null, $this->recepient_group->ReadOnly);
