 ...
 * Page class
 */
class MainGroupPaQuestionsDelete extends MainGroupPaQuestions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainGroupPaQuestionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("maingrouppaquestionslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("maingrouppaquestionslist"); // Return to list
                return;
            }
        }
