 ...
 * Page class
 */
class MainPaAppraisalhistoryDelete extends MainPaAppraisalhistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainPaAppraisalhistoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mainpaappraisalhistorylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mainpaappraisalhistorylist"); // Return to list
                return;
            }
        }
